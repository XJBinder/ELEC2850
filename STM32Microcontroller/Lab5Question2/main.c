...
int main(void) {
	...
	*ptrMode = *ptrMode | (1 << 30);
	...
	// Green LED
	*ptrOutput = *ptrOutput | (1 << 12);
	// Orange LED
	*ptrOutput = *ptrOutput | (1 << 13);
	// Red LED
	*ptrOutput = *ptrOutput | (1 << 14);
	// Blue LED
	*ptrOutput = *ptrOutput | (1 << 15);
	// Delay
